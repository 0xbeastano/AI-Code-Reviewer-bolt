      ...
      <section className="relative overflow-hidden pt-16 pb-24 sm:pt-24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          >
            ...
            {/* Floating badges */}
            <motion.div 
              className="absolute -top-6 -right-6 bg-gradient-ai text-white px-4 py-2 rounded-lg shadow-lg"
              animate={{ 
                y: [0, -5, 0],
                rotate: [0, 2, 0]
              }}
          ...
          <div className="mt-20 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-x-12 gap-y-8">
              {['Microsoft', 'Airbnb', 'Shopify', 'Netflix', 'Stripe'].map((company, index) => (
                <motion.div 
                  key={company} 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              >
                <motion.div 
                  className="w-14 h-14 bg-white dark:bg-gray-800 rounded-lg flex items-center justify-center shadow-md mb-6"
                  whileHover={{ rotate: 5 }}
                >
                  {feature.icon}
                </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              >
                <motion.div 
                  className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 shadow-lg relative z-10"
                  whileHover={{ y: -5, boxShadow: "0 25px 50px -12px rgba(0, 0, 0, 0.25)" }}
                >
                  <motion.div 
                    className="absolute -top-6 -left-6 w-14 h-14 bg-gradient-ai rounded-full flex items-center justify-center shadow-lg"
                    animate={{ 
                      scale: [1, 1.1, 1],
                      rotate: [0, 5, 0]
                    }}
                ...
                {index < 2 && (
                  <motion.div 
                    className="hidden md:block absolute top-1/2 left-full w-16 h-1 bg-gradient-ai transform -translate-y-1/2 z-0"
                    initial={{ width: 0 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <motion.li whileHover={{ x: 5 }}>
                  <Link to="/enterprise" className="text-gray-400 hover:text-white transition-colors">Enterprise</Link>
                </motion.li>
                <motion.li whileHover={{ x: 5 }}>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <motion.li whileHover={{ x: 5 }}>
                  <Link to="/api" className="text-gray-400 hover:text-white transition-colors">API Reference</Link>
                </motion.li>
                <motion.li whileHover={{ x: 5 }}>
                  <Link to="/guides" className="text-gray-400 hover:text-white transition-colors">Guides</Link>
                </motion.li>
                <motion.li whileHover={{ x: 5 }}>
