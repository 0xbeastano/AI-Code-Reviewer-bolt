...
import { Github, Mail, Eye, EyeOff, Code, ArrowLeft } from 'lucide-react';
...
const AuthPage: React.FC = () => {
  ...
  const handleOAuthLogin = async (provider: 'google' | 'github') => {
    setIsLoading(true);
    try {
      // TODO: Implement OAuth login when backend is ready
      ...
      if (provider === 'google') {
        ...
        alert('GitHub OAuth integration coming soon! Please use email/password for now.');
      }
    } finally {
      setIsLoading(false);
    }
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <div className="flex justify-center">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-2xl font-bold text-gray-900 dark:text-white">AI Code Review</span>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 py-8 px-4 shadow-xl rounded-lg sm:px-10 border border-gray-200 dark:border-gray-700">
          ...
          <div className="space-y-3">
            <button
              ...
              disabled={isLoading}
              className="w-full inline-flex justify-center items-center px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm bg-white dark:bg-gray-700 text-sm font-medium text-gray-500 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
            ...
            <div>
              ...
              <div className="mt-1 relative">
                <input
                  ...
                  onChange={handleInputChange}
                  className="appearance-none block w-full px-3 py-2 pl-10 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm placeholder-gray-400 dark:placeholder-gray-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
