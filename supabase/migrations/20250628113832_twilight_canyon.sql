...
2. Changes
   - Modify profiles table to use BIGSERIAL for id column
   - Update handle_new_user function to not specify id value
...
BEGIN
  IF EXISTS (
    ...
    -- Recreate the profiles table with proper ID generation
    ALTER TABLE profiles ALTER COLUMN id DROP DEFAULT;
    ALTER TABLE profiles ALTER COLUMN id SET DATA TYPE BIGSERIAL;
  ELSE
